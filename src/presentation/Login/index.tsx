...
const LoginScreen = () => {
    ...
    if (isLoading) {
        return (
            <div>
                <Titlebar title="ZaChat - Login" visible={false} />
                <LoadingMask className="login-auth-loading" title={t('authenticating')} />
            </div>
        );
    }
    ...
    return (
        <div>
            <Titlebar title="ZaChat - Login" visible={!form.isSubmitting} />
